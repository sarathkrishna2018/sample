...
public abstract class GeneralRuleService implements Serializable {
	...
	private GeneralRuleBo setRulePriority(ReactionRulesetBo reactionRulesetBo, GeneralRuleBo reactionRuleBo) {
		List<ReactionRule> ruleList = getAllRulesByRuleSetId(reactionRulesetBo.getRulesetId());
		if (ruleList != null && !ruleList.isEmpty()) {
			reactionRuleBo.setRulePriority(ruleList.size() + 1L);
		} else {
 ...
 */
	...
	private List<ReactionRule> getAllRulesByRuleSetId(Long rulesetId) {
