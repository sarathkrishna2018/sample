...
public class ReactionRuleDmnConstants {
	...
	public static final String RULE_TYPE_PROPOSED_NOT_REACT = "Propose Not To React";
	public static final String RULE_TYPE_REACTION_PERIOD = "Reaction Period";
	public static final String PRICE_PRODUCT_HIERARCHY_ALL_VALUE = "1";
	public static final List<String> LANG_PREFERENCE_NL = Arrays.asList("NL","FR", "EN");
	public static final List<String> LANG_PREFERENCE_FR = Arrays.asList("FR","NL", "EN");
	public static final List<String> LANG_PREFERENCE_EN = Arrays.asList("EN","NL", "FR");
	...
	public static final String PRICECONFIG_SECRET_KEY= "priceconfig_secret_key";
	public static final String UTF_8 = "UTF-8";
	public static final int EXPIRY_MINUTES = 24 * 60;
